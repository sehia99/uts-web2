...
include '../../../config.php'; 
$sql=$query->prepare("select akta.*, ktp.gambar from ktp inner join akta on ktp.nik=akta.nik where ktp.tempo=1");
$sql->execute();
$data=$sql->fetchAll();
?>
					...
					<td><img src="../../../foto-ktp/<?php echo $value['gambar']; ?>" width="100px" height="100px"></td>
 					...
 					<td><div class="dropdown">
  							...
  							<ul class="dropdown-menu">
   								<li><a href="../restore/restore_ktp.php?nik=<?php echo $value['nik']; ?>">Restore</a></li>
    							<li><a href="../hapus/hapus_ktp.php?nik=<?php echo $value['nik']; ?>">Permanent Delete</a></li>
  							</ul>
						</div></td>
				</tr>
			<?php endforeach; ?>

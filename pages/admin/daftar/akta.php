...
<br>
  ...
  include '../../../config.php';
	  ...
	  $sql=$query->prepare("insert into akta (nama, tempatL, tanggalL,gender,goldarah,alamat,rtrw,desa,kec,agama,status,pekerjaan,nama_ayah,nama_ibu,pendidikan) VALUES(:nama,:tempatL,:tanggalL,:gender,:goldarah,:alamat,:rtrw,:desa,:kec,:agama,:status,:pekerjaan,:nama_ayah,:nama_ibu,:pendidikan)");
